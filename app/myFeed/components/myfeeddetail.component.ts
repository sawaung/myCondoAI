...
import { View } from 'tns-core-modules/ui/editable-text-base/editable-text-base';
...
export class MyFeedDetailComponent implements OnInit,AfterViewInit {
    ...
    ngAfterViewInit() {
        ...
        var myContainer:View = this.container.nativeElement;
        if(myContainer != null){
            console.log("myContainer not null");
        }else{
            console.log("myContainer is null");
        }
        this.webViewTemp = myContainer.getViewById<WebView>("myWebViewTemp");
        
        this.webViewDescription = myContainer.getViewById<WebView>("myWebView");
